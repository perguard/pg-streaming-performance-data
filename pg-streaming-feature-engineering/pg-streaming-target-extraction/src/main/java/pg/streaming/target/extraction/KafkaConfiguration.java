...
public class KafkaConfiguration {
    ...
    private int slowdownThreshold = -1;
    ...
    public KafkaConfiguration(String bootstrapServers, String groupId, String inputTopic, String outputTopic,
                              int windowDurationInSeconds, int hoppingDurationInSeconds, int slowdownThreshold) {
        ...
        this.slowdownThreshold = slowdownThreshold;
    }

    private void initConfigFromFile() {
        try (InputStream input = TargetExtractionKafkaStreams.class.getClassLoader().getResourceAsStream("config.properties")) {
            ...
            this.slowdownThreshold = Integer.parseInt(prop.getProperty("app.slowdown-threshold"));
        } catch (Exception io) {
    ...
    private void initConfigFromEnvironmentVariables() {
        ...
        try {
            ...
            if (System.getenv("app.slowdown-threshold") != null) {
                this.slowdownThreshold = Integer.parseInt(System.getenv("app.slowdown-threshold"));
            }
